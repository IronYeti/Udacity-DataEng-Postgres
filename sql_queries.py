...
WHERE s.title = %s AND a.name = %s AND s.duration = CAST(%s AS VARCHAR)
""")

# QUERY LISTS

create_table_queries = [artist_table_create, user_table_create, song_table_create, time_table_create, songplay_table_create]
drop_table_queries = [user_table_drop, song_table_drop, time_table_drop, songplay_table_drop, artist_table_drop]